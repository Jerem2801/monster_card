        ...
        <div className="flex items-start flex-nowrap w-full gap-4">
            ...
            {!selected && (
                <div className="flex items-center gap-1 flex-shrink-0 pt-3">
                    ...
                    <button
                        className="px-2 py-0.5 bg-green-200 rounded text-sm text-green-700 font-bold hover:bg-green-300 cursor-pointer transition-colors"
                        onClick={add}
                    >
            ...
            {selected && (
                <div className="flex items-center gap-1 flex-shrink-0 pt-3">
                    <button
                        className="px-2 py-0.5 bg-red-200 rounded text-sm text-red-700 font-bold hover:bg-red-300 cursor-pointer transition-colors"
                        onClick={remove}
                    >
