        ...
        <div className="mx-auto max-w-xs">
            ...
            <div className="relative flex max-w-[8rem] items-center">
                <button
                    ...
                    className={`h-11 cursor-pointer rounded-s-lg border border-gray-300 bg-gray-100 p-3 shadow-md transition-transform hover:bg-gray-200 focus:outline-none active:scale-95 ${Number(value) <= min ? 'cursor-not-allowed opacity-50' : ''}`}
                >
                    <svg
                ...
                <button
                    ...
                    className={`h-11 cursor-pointer rounded-e-lg border border-gray-300 bg-gray-100 p-3 shadow-md transition-transform hover:bg-gray-200 focus:outline-none active:scale-95 ${typeof max === 'number' && Number(value) >= max ? 'cursor-not-allowed opacity-50' : ''}`}
                >
                    <svg
                        className="h-3 w-3 text-gray-900 dark:text-white"
                        aria-hidden="true"
