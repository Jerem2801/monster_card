export const STATUSES = [
    ...
    },
    {
        ...
        label: 'Pétrifié',
        description:
            'Incapable. Devient une pierre, immunisé à la plupart des dégâts sauf outils puissants/explosifs.',
        emoji: '🪨',
    },
    {
        id: 'poisoned',
    ...
    },
    {
        ...
        label: 'À terre',
        description:
            'Se déplacer coûte deux fois plus. Attaques à distance : désavantage ; mêlée : avantage.',
        emoji: '🤕',
    },
    {
        id: 'slowed',
