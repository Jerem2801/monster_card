...
import {
    isGoodBeforeSaveEncounter,
    getMonsterToSave,
    saveOrUpdateEncounter,
    loadEncounter,
...
export default function EncounterForm({ encounterId }) {
    ...
    const sortedMonsters = [...dataMonsters].sort(
    ...
    const saveEncounter = async () => {
        ...
        if (
            !(await isGoodBeforeSaveEncounter(encounterId, encounterNameTrimmed, selectedMonsters))
        ) {
            return;
        }
        ...
        try {
            ...
            alert(
                "Une erreur est survenue lors de l'enregistrement de la rencontre. Veuillez réessayer.",
            );
        }
    };
